...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-[#0B0F19] text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden flex items-center justify-center p-0 sm:p-4 lg:p-8">
            ...
            <main className="w-full max-w-7xl flex flex-col lg:flex-row bg-[#0D121F]/80 backdrop-blur-3xl border-y sm:border border-white/5 sm:rounded-[32px] shadow-[0_32px_128px_-16px_rgba(0,0,0,0.5)] overflow-hidden relative z-10 min-h-screen sm:min-h-fit lg:min-h-[850px]">
                
                {/* LEFT: LOGIN FORM */}
                <div className="w-full lg:w-1/2 p-6 sm:p-10 lg:p-20 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-white/10 sm:border-white/5">
                    <motion.div 
